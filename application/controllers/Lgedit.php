...
//var_dump($datas); exit;
			...
			if(isset($datas['api_laborantin'])){
				$prescription = $this->lg->get_data('ordonnances',array('pvv' => $datas['pvv']),true);
				$prescription['laborantin'] = $this->session->userdata('user_id');
				$datas = $prescription;
			}
