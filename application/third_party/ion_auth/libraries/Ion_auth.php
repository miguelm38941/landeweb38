...
class Ion_auth
{
	...
	public function restrict_access($perms_array){
		if (!$this->ion_auth->in_group($perms_array)) die('Vous devez avoir les permissions requises pour consulter ces données. <br> <a href="'.@$_SERVER['HTTP_REFERER'].'" title="Retour &agrave; la page pr&eacute;c&eacute;dente">Retour</a>');
	}
