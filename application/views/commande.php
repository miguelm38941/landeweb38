...
<table id="commande_summary" border="1" style="width:30%">
...
<a class="btn" href="<?= $_SERVER['HTTP_REFERER'] ?>" style="margin-top:20px;">BACK</a>

<a href="<?= site_url('/backend/exportPdf/commande/'.$commande['id']) ?>" target="_blank" class="btn" style="margin-top:20px;" >Imprimer</a>
</div>
