...
<main>
<div class="container">
<h3 style="background:#eee;padding:10px;">Stocks &eacute;puis&eacute;s</h3>
<div class="row">
	...
	<table class="highlight">
        ...
        <?php foreach( $datas as $data): ?>
            ...
            <tr data-id="1" class="" data-dblclick="">
                ...
                <td data-name="quantite" class=""><?= $data['stock']['quantite'] ?></td>
                <td data-name="peremption" class="">
                    <?= $data['stock']['peremption'] ?>
                </td>
                <td data-name="peremption" class="">
                    <a class="btn waves-effect waves-light" href="<?= site_url('/backend/mail_alertes/'.$data['organisation']['id'].'_'.$data['produit']['id'].'_'.$data['stock']['quantite']) ?>" name="action" value="">Envoyer un rappel</a>
                </td>
            </tr>
        <?php endforeach; ?>
        </tbody>
